...
# Fungsi untuk memeriksa apakah pergerakan ke atas, ke bawah, atau ke kanan adalah langkah yang valid
...
def main():
    ...
    while True:
        try:
            ...
            C = int(input("Masukkan jumlah langkah ke bawah (C): "))  # Memperbaiki langkah 'C' ke bawah
            break
        except ValueError:
    ...
    for _ in range(C):
        if not periksa_langkah_valid(x, y, 'C'):
            print("Anda menabrak rintangan atau mencapai batas bawah. Game Over!")  # Memperbaiki pesan kesalahan
            break
        x += 1
    ...
    # Mencetak grid dengan posisi 'X' sesuai dengan koordinat akhir
    ...
    print("Grid dengan posisi 'X' dengan koordinat akhir:")
    tampilkan_grid()
